...
typedef enum { BARE = 0, DEFAULT = 1, FULL = 2, PLUS = 3, UNKNOWN = 4 } project_flag_t;

typedef enum { NONE = 0, GITIGNORE, CLANGD, MAKEFILE, MAIN_C, HEADER, README, TEST_C } file_maker_mode_t;
